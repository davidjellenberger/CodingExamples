...
public class Message {
  ...
  /** Initializes an instance of <code>Message</code> by reading bytes from an
   *  <code>InputStream</code> using <code>fieldTerminator</code> as a field
  ...
  public Message(InputStream inStream) throws IOException, ArrayIndexOutOfBoundsException {
   ...
   *  would be written during the <code>send</code> method. Header is padded to
   *  be <code>HEADER_BYTES</code> bytes long.
   ...
   *    each terminiated by <code>fieldTerminator</code>. Padded to be <code>
   *    HEADER_BYTES</code> bytes long. */
